      ...
      <div className="max-w-md w-full bg-white rounded-sm shadow-card p-8 text-center">
        {status === 'loading' && (
          <>
            ...
            <h1 className="text-heading font-semibold text-ink mb-2">กำลังเตรียมการชำระเงิน</h1>
        ...
        {status === 'redirecting' && (
          <>
            <div className="w-10 h-10 mx-auto mb-4 border-2 border-brand-600 border-t-transparent rounded-full animate-spin" />
            <h1 className="text-heading font-semibold text-ink mb-2">กำลังพาไปยังหน้าชำระเงิน</h1>
        ...
        {status === 'already' && (
          <>
            <h1 className="text-heading font-semibold text-ink mb-2">คุณลงทะเบียนคอร์สนี้แล้ว</h1>
            <p className="text-sm text-ink-muted">กำลังพาคุณกลับไปยังหน้าคอร์ส...</p>
          </>
        )}
