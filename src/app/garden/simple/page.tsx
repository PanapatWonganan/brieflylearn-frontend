        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-500 mt-1">สร้างและพัฒนาโปรเจกต์ AI ไปด้วยกัน</p>
            </div>

            <div className="flex space-x-4">
              <div className="border border-gray-700 rounded-sm px-4 py-2.5 flex items-center space-x-2">
                <span>🔷</span>
                <span className="font-bold text-gray-200">{aiCredits} AI Credits</span>
              </div>
              <div className="border border-gray-700 rounded-sm px-4 py-2.5 flex items-center space-x-2">
                <span>📈</span>
                <span className="font-bold text-gray-200">{impactPoints} Impact Points</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center space-x-2">
                <div className="px-3 py-1 border border-gray-700 rounded-sm flex items-center space-x-1">
                  <span>👑</span>
                  <span className="font-bold text-sm text-gray-200">Level {gardenLevel}</span>
                </div>
              </div>
              <span className="text-sm text-gray-500">{impactPoints} / 1000 Impact Points</span>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-900 rounded-sm border border-gray-700 p-6 space-y-4">
              ...
              <motion.button
                className="w-full bg-mint-500 hover:opacity-90 text-white py-3 px-4 rounded-sm font-medium flex items-center justify-center space-x-2 transition-colors"
                whileTap={{ scale: 0.98 }}
              >
                <span>💧</span>
                <span>พัฒนาแล็บ</span>
              ...
              <motion.button
                className="w-full border border-gray-700 text-gray-200 hover:border-gray-600 py-3 px-4 rounded-sm font-medium flex items-center justify-center space-x-2 transition-colors"
                whileTap={{ scale: 0.98 }}
              >
                <span>➕</span>
              ...
              <div className="bg-gray-800/50 rounded-sm p-4 space-y-2">
                <h4 className="font-semibold text-sm text-gray-400">สรุปแล็บ</h4>
                <div className="space-y-1 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-500">ขยายผลแล้ว:</span>
            ...
            {/* Today's Goals */}
            <div className="bg-gray-900 rounded-sm border border-gray-700 p-6 mt-6">
                ...
                {[
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      {goal.completed && <span className="text-mint-400">🏆</span>}
                    </div>
                    <div className="w-full h-1 bg-gray-700 rounded-full overflow-hidden">
                      <div
                        className={`h-full ${goal.completed ? 'bg-mint-400' : 'bg-gray-200'} transition-all duration-300`}
          ...
          <div className="lg:col-span-3">
            <div className="bg-gray-900 rounded-sm border border-gray-700 p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-sm text-gray-500">อัปเดตล่าสุด: เมื่อสักครู่</span>
              </div>
              ...
              <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                ...
                {[
                  ...
                  <motion.div
                    key={index}
                    className={`w-32 h-32 relative rounded-sm border-2 cursor-pointer transition-all duration-300 ${
                      project.needsIteration ? 'border-red-500/30 bg-red-500/10' : 'border-mint-500/30 bg-gray-800/50'
                    }`}
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    <div className="absolute inset-2 rounded-sm bg-gray-800/30 flex items-center justify-center">
                    ...
                    <div className="absolute top-1 left-1 right-1">
                      <div className="h-1 bg-gray-700 rounded-full overflow-hidden">
                        <div
                          className={`h-full ${project.health > 70 ? 'bg-mint-400' : 'bg-amber-500'}`}
